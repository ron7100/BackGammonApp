...
namespace BackGammonApp.Services
{
    class BackGammonAPIProxy
    {
        ...
        private static BackGammonAPIProxy proxy = null;

        public static BackGammonAPIProxy CreateProxy()
        {
            string baseUri;
            ...
            if (proxy == null)
                proxy = new BackGammonAPIProxy(baseUri, basePhotosUri);
            return proxy;
        }


        private BackGammonAPIProxy(string baseUri, string basePhotosUri)
        {
